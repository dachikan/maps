...
<body>
	...
	<tbody>
		...
		while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
		    ...
		    switch ($row['MapType']) {
				case 13:
					echo "<td><a href=\"https://nsk.org/maps/noteMapNew.html?lat=" . urlencode($row['Lat']) . "&lng=" . urlencode($row['Lng']) . "&title=" . urlencode($title) . "\">" . $title . "</a></td>";
					break;
				case 9:
				...
				case 1:
					...
					break;
				case 3:
					echo "<td><a href=\"https://nsk.org/maps/noteMapNew.html?lat=" . urlencode($row['Lat']) . "&lng=" . urlencode($row['Lng']) . "&title=" . urlencode($title) . "&mapdata=" . urlencode($row['MapData']) . "\">" . $title . "</a></td>";
					break;
				default:
					echo "<td><a href=\"https://nsk.org/maps/noteMapNew.html?title=" . urlencode($title) . "\">" . $title . "</a></td>";
				}
